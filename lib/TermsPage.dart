...
class TermsPageWithRegister extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Leia até o final para se registrar"),
      ),
      body: Padding(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => RegisterPageStep1(),
                          ),
                        );
                      },
                      child: Text("Aceitar e Registrar"),
                    ),
                  ),
                ],
              ),
